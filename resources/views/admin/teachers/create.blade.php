...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="ethereal-card">
            ...
            <form id="teacherCreateForm" method="POST" action="{{ route('teachers.store') }}" autocomplete="off">
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="name" class="form-control form-glass" placeholder="Enter teacher's name" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Father's Name</label>
                        <input name="father_name" class="form-control form-glass" placeholder="Father's name">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Phone Number</label>
                        <input id="phoneInput" name="phone" type="tel" inputmode="numeric" maxlength="15" autocomplete="off" spellcheck="false" class="form-control form-glass" placeholder="Contact number" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Email Address</label>
                        {{-- Added autocomplete="off" and empty value --}}
                        <input name="email" type="email" class="form-control form-glass" placeholder="teacher@example.com" autocomplete="off" value="">
                    </div>

                    <div class="col-12">
                        <label class="form-label">Initial Password</label>
                        <input name="password" type="password" class="form-control form-glass" required autocomplete="new-password">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <img id="photoPreview" src="" alt="Teacher photo" class="photo-preview">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text mt-2"><i class="fa-solid fa-circle-check me-1"></i> Select all applicable subjects.</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text mt-2"><i class="fa-solid fa-location-dot me-1"></i> Select one or more branches.</div>
                    </div>

                    <div class="col-12 mt-4">
                        <button class="btn btn-save">
                            <i class="fa-solid fa-check"></i> Create Teacher Account
                        </button>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (teacherCreateForm && phoneInput) {
        teacherCreateForm.addEventListener('submit', function () {
