    ...
    <div class="col-lg-10">
        ...
        <div class="ethereal-card">
            ...
            <form id="studentForm" action="{{ route('students.store') }}" method="POST">
                ...
                <input type="hidden" name="photo_path" id="uploadedPhotoPath">
                <input type="hidden" name="aadhaar_path" id="uploadedAadhaarPath">

                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input name="name" class="form-control form-glass" required placeholder="Enter student name">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Father's Name</label>
                        <input name="father_name" class="form-control form-glass" placeholder="Enter father's name">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Date of Birth</label>
                        <input type="date" name="dob" class="form-control form-glass">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="phone" class="form-control form-glass" placeholder="Contact number">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">WhatsApp Number</label>
                        <input name="whatsapp" class="form-control form-glass" placeholder="WhatsApp number">
                    </div>

                    <div class="col-12">
                        <label class="form-label">Address</label>
                        <textarea name="address" class="form-control form-glass" rows="2" placeholder="Full residential address"></textarea>
                    </div>
                    ...
                    {{-- UPDATED: Dynamic Year Label Logic --}}
                    <div class="col-12">
                        <label class="form-label mb-2">Subjects & Year Levels</label>
                        <div id="subjectYearArea">
                            <div class="row mb-3 subject-year-row align-items-end">
                                <div class="col-md-6">
                                    ...
                                    <select name="subject_years[0][subject_id]" class="form-select form-glass subject-select" onchange="updateYearOptions(this)">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="subject_years[0][year_label]" class="form-select form-glass year-select">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex gap-2 align-items-start">
                            <label for="photoInput" class="btn btn-glass file-upload-label flex-grow-1">
                                <span id="photoFileName" class="file-name-span">Choose Photo</span>
                        ...
                        <div class="small-muted mt-2" style="color: rgba(255,255,255,0.5); font-size: 0.8rem;">
                            Select file or use Camera. <b>Both will allow cropping.</b>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="aadhaarInput" class="btn btn-glass file-upload-label w-100">
                            <span id="aadhaarFileName" class="file-name-span">Choose Aadhaar Scan</span>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.subject-select').forEach(select => {
        if(select.value) updateYearOptions(select);
        else updateYearOptions(select); // Initialize with standard list by default
    });
});
